...
const Skills = () => {
  return (
    <>
        ...
        <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark dark:text-dark dark:bg-light">
            ...
            <Skill name="Adobe XD" x="-5vw" y="-10vw" />
