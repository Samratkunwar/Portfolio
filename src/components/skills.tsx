  ...
  return (
    <>
        ...
        <div className="w-full h-screen relative flex items-center justify-center 
                        rounded-full bg-circularLight dark:bg-circularDark dark:text-dark 
                        dark:bg-light lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] 
            ...
            <Skill name="NextJS" x="-15vw" y="25vw" />
            <Skill name="SQL" x="15vw" y="-12vw" />
            <Skill name="Web Design" x="32vw" y="-5vw" />
            <Skill name="Figma" x="-5vw" y="-28vw" />
            <Skill name="Adobe XD " x="0vw" y="-20vw" />
