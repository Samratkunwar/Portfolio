...
const Details = ({position="", company="", time="", work=""}) => {
    ...
    return <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justigy-between md:w-[80%]'>
        ...
        >
            <h3 className='capitalize font-bold text-2xl sm:text-xl xs:text-lg'>{position} &nbsp; <span className='text-primary capitalize dark:text-primaryDark'>@{company}</span></h3>
