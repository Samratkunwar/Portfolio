...
export default function Home() {
  return (
    <>
      <Head>
        <title>Samrat Kunwar | ePortfolio</title>
        <meta name="portfolio" content="React app created using NextJS" />
      </Head>
      <TransitionEffect />
        ...
        <Layout className='pt-0 md:pt-16 sm:pt-8'>
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className='w-1/2 md:w-full'>
              <Image src={profilePic} alt="Profile picture" className='w-full h-auto lg:hidden md:inline-block md:w-full' 
                priority
